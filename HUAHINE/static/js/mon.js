...
const updateSaveInterval = () => {
    ...
    if (AppState.updateSaveInterval(newInterval)) {
        ...
        const timer = setInterval(() => {
          if (remainingSeconds > seuilSecondes + 1) {
            ...
            `;
          } else if (remainingSeconds === seuilSecondes) {
            saveInfoElement.innerHTML = `
              <img src="./static/icone/enregistrement.png" alt="Historique" width="16" height="16">
          ...
          if (remainingSeconds < seuilSecondes) {
        ...
        showMessage(
          `Départ du parcours - Enregistrement en mémoire dans ${AppState.saveInterval * (intervalMs / 1000)}s.`,
          "success"
        );
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('saveInterval').addEventListener('change', function () {
        ...
        if (AppState.updateSaveInterval(newInterval)) {
            ...
            alert("Intervalle invalide (1 à 60 secondes)");
        }
});
